...
const App = () => {
    ...
    const token = useToken("0xeA27E4cb972a453bEf304c93E421bC2b466a15b1");
    const vote = useVote("0xCf3a0Bc10ce05B0807d642C3DCdc4778c5FB5490");
    ...
    const mintNft = async () => {
        try {
            ...
            // https://testnets.opensea.io/assets/0xDD0caFEd1584AD792c8E719489BB94E2Ce6D1d91/0
            setHasClaimedNFT(true);
        } catch (error) {
            setHasClaimedNFT(false);
    ...
    if (!address) {
        return (
            <div className="landing">
                <h1>Welcome to DeathNote DAO!</h1>
